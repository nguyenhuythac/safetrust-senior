...
import com.safetrust.inventory_service.mapper.UserMapper;
...
public class UserController {
    ...
    /**
    * 
    * <p>Get pagination users Restful api</p>
    ...
    */
    ...
    public ResponseEntity<List<UserDTO>> getusers(@PathVariable("offset") int offset, @PathVariable("pageSize") int pageSize) {
    ...
    /**
    * 
    * <p>Search users by name Restful api</p>
    ...
    */
    ...
    /**
    * 
    * <p>Get user By Id Restful api</p>
    ...
    */
    @GetMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<UserDTO> getuserById(@PathVariable("id") int id) throws EntityNotFoundException {
    ...
    /**
    * 
    * <p>Create new user Restful api</p>
    ...
    */
    ...
    /**
    * 
    * <p>Update an existing user Restful api</p>
    ...
    */
    ...
    /**
    * 
    * <p>Delete a user with id Restful api</p>
